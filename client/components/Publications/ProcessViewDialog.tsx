          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg">
              <div className="flex items-center space-x-4">
                <Badge className={`${getStatusColor(process.status)} px-3 py-1`}>
                  {process.status}
                </Badge>
                <span className="font-mono text-lg font-semibold">{process.numero}</span>
              </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm font-medium">Data da Movimentação</p>
                        <p className="text-sm text-muted-foreground">
                          {process.dataUltimaMovimentacao?.toLocaleDateString('pt-BR', {
                            weekday: 'long',
                            year: 'numeric',
                            month: 'long',
                            day: 'numeric'
              ...
              <div className="bg-muted/30 p-4 rounded-lg">
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        <p className="font-medium text-sm">{process.ultimaMovimentacao}</p>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        <p className="font-medium text-sm">Petição inicial distribuída</p>
                        <span className="text-xs text-muted-foreground">
