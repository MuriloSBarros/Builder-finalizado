...
interface OptimizedScrollAreaProps extends React.ComponentPropsWithoutRef<typeof ScrollAreaPrimitive.Root> {
  /**
...
>(({ className, children, preventResizeLoop = false, resizeDebounce = 150, ...props }, ref) => {
  const [shouldUseScrollArea, setShouldUseScrollArea] = React.useState(!preventResizeLoop);
